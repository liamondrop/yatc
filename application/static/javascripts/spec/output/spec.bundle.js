...
var _collections = require('../../../src/collections');

describe('StatusCollection', function () {
  it("should be an instance of a Collection", function () {
    var screenName = 'twitter';
    var statuses = new _collections.StatusCollection({ screenName: screenName });
    var actual = statuses instanceof _backbone.Collection;
    var expected = true;
  ...
  describe('setProp', function () {
    beforeEach(function () {
      this.statuses = new _collections.StatusCollection();
    });

    it("should have an empty property object to start", function () {
      var actual = this.statuses.props;
      var expected = {};
    ...
    it("should add a property with with the first argument equal to the key and the second argument equal to the value", function () {
      ...
      var actual = this.statuses.props;
      var expected = { testProp: testProp };
      expect(actual).toEqual(expected);
    });
  });

  it("should throw an exception if no screenName property is set", function () {
    var statuses = new _collections.StatusCollection();
    var actual = function actual() {
      return statuses.url();
    };
    var expected = 'StatusCollection requires a screenName property to be set before it can fetch';
  ...
  it("should have a url like '/statuses/<screenName>' after screenName prop is set", function () {
    ...
    var actual = statuses.url();
    var expected = '/statuses/' + screenName;
    expect(actual).toBe(expected);
  });
  ...
  it("should properly parse a JSON reponse into a collection of Models", function (done) {
    ...
    statuses.on('sync', function (collection) {
      var model = collection.at(0);
      if (collection.length > 0) {
        var actual = model.keys();
        var expected = ["created_at", "created_at_nice", "id", "name", "profile_image_url", "retweet_count", "screen_name", "text", "parsed_text"];
        expect(actual).toEqual(expected);
      } else {
...
},{"../../../src/collections":8,"backbone":1}],5:[function(require,module,exports){
'use strict';
...
var _views = require('../../../src/views');

describe('TimelineView', function () {
  it("should be an instance of a View", function () {
    var view = new _views.StatusFilterView({
      collection: new _collections.StatusCollection()
    });
    var actual = view instanceof _backbone.View;
    var expected = true;
    expect(actual).toBe(expected);
  });
});

},{"../../../src/collections":8,"../../../src/views":14,"backbone":1}],6:[function(require,module,exports){
'use strict';
...
describe('TimelineView', function () {
  it("should be an instance of a View", function () {
    var view = new _views.TimelineView({
      collection: new _collections.StatusCollection()
    });
    var actual = view instanceof _backbone.View;
    var expected = true;
...
},{"../../../src/collections":8,"../../../src/views":14,"backbone":1}],7:[function(require,module,exports){
'use strict';
...
describe('UserLookupView', function () {
  it("should be an instance of a View", function () {
    var view = new _views.UserLookupView({
      collection: new _collections.StatusCollection()
    });
    var actual = view instanceof _backbone.View;
    var expected = true;
...
},{"../../../src/collections":8,"../../../src/views":14,"backbone":1}],8:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.StatusCollection = undefined;

var _statusCollection = require('./status-collection');

var _statusCollection2 = _interopRequireDefault(_statusCollection);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.StatusCollection = _statusCollection2.default;

},{"./status-collection":9}],9:[function(require,module,exports){
'use strict';
...
var StatusCollection = _backbone.Collection.extend({
  ...
  url: function url() {
    ...
    if (!(0, _underscore.isObject)(props) || (0, _underscore.isEmpty)(props.screenName) || !(0, _underscore.isString)(props.screenName)) {
  ...
  lookup: function lookup(query) {
    if ((0, _underscore.isString)(query) && query.length) {

      // filter the models in the collection based on their 'text' property
      var results = this.filter(_matcher(query, 'text'));
...
function _matcher(query, searchProp) {
  ...
  return function _matcherFilter(model) {
    ...
    var searchee = model.get(searchProp);
    ...
    if (regex.test(searchee)) {
      ...
      var index = searchee.indexOf(query);
      var matches = searchee.match(regex);
...
},{"../models":10,"backbone":1,"underscore":3}],10:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.StatusModel = undefined;

var _statusModel = require('./status-model');
...
},{"./status-model":11}],11:[function(require,module,exports){
'use strict';
...
var StatusModel = _backbone.Model.extend({
  ...
  parseText: function parseText(text) {
    ...
    return text.replace(pattern, function ($1, match) {
      var trunc = match.replace(/http[s]?:\/\//, '');
...
exports.statusPanels = undefined;

var _statusPanels2 = require('./status-panels');

var _statusPanels3 = _interopRequireDefault(_statusPanels2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.statusPanels = _statusPanels3.default;

},{"./status-panels":13}],13:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = statusPanels;
...
function statusPanels(collection) {
...
exports.StatusFilterView = exports.TimelineView = exports.UserLookupView = undefined;

var _userLookupView = require('./user-lookup-view');

var _userLookupView2 = _interopRequireDefault(_userLookupView);

var _timelineView = require('./timeline-view');

var _timelineView2 = _interopRequireDefault(_timelineView);

var _statusFilterView = require('./status-filter-view');

var _statusFilterView2 = _interopRequireDefault(_statusFilterView);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.UserLookupView = _userLookupView2.default;
exports.TimelineView = _timelineView2.default;
exports.StatusFilterView = _statusFilterView2.default;

},{"./status-filter-view":15,"./timeline-view":16,"./user-lookup-view":17}],15:[function(require,module,exports){
'use strict';
...
var StatusFilterView = _backbone.View.extend({
  initialize: function initialize(options) {
    (0, _underscore.bindAll)(this, '_onInputKeyup');
    this.cacheElements();
  ...
  _onInputKeyup: function _onInputKeyup(e) {
    var filtered = this.collection.lookup(e.target.value);
    this.timelineView.$panelGroup.html((0, _templates.statusPanels)(filtered));
    this.$result.text(filtered.length);
  },
  _onCollectionRequest: function _onCollectionRequest() {
    this.$input.prop('disabled', true);
  },
  _onCollectionComplete: function _onCollectionComplete(collection) {
...
exports.default = StatusFilterView;

},{"../templates":12,"backbone":1,"underscore":3}],16:[function(require,module,exports){
'use strict';
...
var TimelineView = _backbone.View.extend({
  initialize: function initialize() {
    this.cacheElements();
    this.setupEventListeners(this.collection);
  },
  ...
  _onCollectionSync: function _onCollectionSync(collection) {
    this.$panelGroup.html((0, _templates.statusPanels)(collection));
    this.$el.removeClass('working initial-load');
  },
  _onCollectionError: function _onCollectionError() {
    this.$el.removeClass('working initial-load');
  }
});
...
},{"../templates":12,"backbone":1}],17:[function(require,module,exports){
'use strict';
...
var UserLookupView = _backbone.View.extend({
  initialize: function initialize() {
    (0, _underscore.bindAll)(this, '_onFormSubmit');
    this.cacheElements();
    this.setupEventListeners(this.collection);
  },
  cacheElements: function cacheElements() {
...
exports.default = UserLookupView;

},{"backbone":1,"underscore":3}]},{},[4,5,6,7]);
